                            ...
                            <div className="lg:h-fit bg-gray-50 flex flex-col md:ml-auto w-full md:py-2 mt-8 md:mt-0">
                                ...
                                <form onSubmit={handleSubmit}>
                                    ...
                                    <ReCAPTCHA
                                        ...
                                        className='mb-2 -mt-2 '
                                    />
                                    <button type='submit' className="w-full text-white bg-gray-900 border-0 py-2 px-6 mt-1 focus:outline-none hover:bg-gray-800 cursor-pointer rounded text-lg">
                                        Submit
                                    </button>
                                </form>
