                        ...
                        <nav className="lg:hidden mt-4">
                            <div className="px-1 py-8">
                                <div className="grid gap-y-7">
                                    ...
                                    <a href="/Blogs" className="text-base font-medium text-gray-900 hover:bg-gray-100 p-3 rounded-xl">Blogs</a>  */}
                                    <a href="/AdminDashboard" className="inline-flex items-center justify-center px-6 py-3 text-base font-bold text-white bg-gray-900 rounded-xl hover:bg-gray-800">
                                        Dashboard
                                    </a>
                                    <a href="#" className="inline-flex items-center justify-center px-6 py-3 text-base font-bold text-black border-2 border-gray-900 rounded-xl hover:bg-gray-100">
                                        Logout
                                    </a>
                                </div>
                            </div>
