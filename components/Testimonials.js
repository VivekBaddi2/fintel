                        ...
                        <div className="flex flex-wrap -m-4">
                            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                                <div className="h-full text-center">
                                    ...
                                    <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">Ravi Sharma
                                    </h2>
                                    <p className="text-gray-500">Founder, StartupNest</p>
                                </div>
                            </div>
                            <div className="lg:w-1/3 lg:mb-0 mb-6 p-4">
                                <div className="h-full text-center">
                                    ...
                                    <span className="inline-block h-1 w-10 rounded bg-blue-500 mt-6 mb-4"></span>
                                    <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">Neha Rao
                                    </h2>
                                    <p className="text-gray-500">Director, BloomWell Enterprises
                                    </p>
                                </div>
                            </div>
                            <div className="lg:w-1/3 lg:mb-0 p-4">
                                <div className="h-full text-center">
                                    ...
                                    <span className="inline-block h-1 w-10 rounded bg-blue-500 mt-6 mb-4"></span>
                                    <h2 className="text-gray-900 font-medium title-font tracking-wider text-sm">Arjun Menon
                                    </h2>
                                    <p className="text-gray-500">CEO, Quantix Technologies
                                    </p>
                                </div>
                            </div>
                        </div>
